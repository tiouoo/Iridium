...
using Iridium.Enums;
using Iridium.Extension.Launch.Layout;
using Iridium.Extension.Minecraft.Parsing;
using Iridium.Minecraft;
using Iridium.Minecraft.Models;

namespace Iridium.Extension.Providers.Minecraft;
...
public sealed class PortalMcProvider : IMinecraftProvider {
    ...
    public PortalMcProvider(DirectoryInfo root) {
        ...
        var versionsRoot = Path.Combine(_root, "meta", "versions");
        
        _merger = new VersionManifestMerger(id => Path.Combine(versionsRoot, id, $"{id}.json"));
    }
