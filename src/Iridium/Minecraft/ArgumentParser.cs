...
/// format-agnostic: directory mapping comes from <c>context.Layout</c> and the whole
/// argument set is derived from the parsed entry model via private helpers — no
/// contributor/strategy extension point is needed.
/// </summary>
